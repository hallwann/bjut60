...
function getClickTimes(newsid, owner,type,randomid) { 
    var url = 'http://60.bjut.edu.cn/system/resource/code/news/click/clicktimes.jsp'; 
    if(!type) type="wbnews";
    if(!randomid)
    {
    	 randomid="n";
...
function _getBatchClickTimes(newsid, owner,type,randomid) { 
    var url = 'http://60.bjut.edu.cn/system/resource/code/news/click/batchclicktimes.jsp'; 
    if(!type) type="wbnews";
    if(!randomid)
    {
    	 randomid="n";
...
function addClickTimes(urlid,owner,type){
		var url = 'http://60.bjut.edu.cn/system/resource/code/news/click/addclicktimes.jsp'; 
        var xmlHttp = createXMLHttpRequest();
